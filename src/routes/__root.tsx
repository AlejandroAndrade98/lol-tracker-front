  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">This page is not part of the tracker.</p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The dashboard hit a rendering issue. Try again or return to the overview.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LoL Tracker | Personal Performance Dashboard" },
      {
        name: "description",
        content: "Personal League of Legends performance dashboard for Jordan Belfort#LAN29.",
      },
      { property: "og:title", content: "LoL Tracker" },
      {
        property: "og:description",
        content: "A focused performance coach dashboard for League of Legends ranked progress.",
      },
